...
def get_eval_set(data_dir,struct_dir):
    return DatasetFromFolderEval(data_dir,struct_dir, transform=transform2())
...
def get_fivek_eval_set(data_dir):
    return FiveKDatasetFromFolderEval(data_dir, transform=transform2())