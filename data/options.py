...
def option():
    # Training settings
    parser = argparse.ArgumentParser(description='ISGNet')
    ...
    parser.add_argument('--data_val_lol_v1_s'         , type=str, default='./datasets/LOLdataset/eval15/low_s')
    parser.add_argument('--data_val_lolv2_real'     , type=str, default='./datasets/LOLv2/Real_captured/Test/Low')
    parser.add_argument('--data_val_lolv2_real_s'     , type=str, default='./datasets/LOLv2/Real_captured/Test/Low_s')
    parser.add_argument('--data_val_lolv2_syn'      , type=str, default='./datasets/LOLv2/Synthetic/Test/Low')
    parser.add_argument('--data_val_lolv2_syn_s'      , type=str, default='./datasets/LOLv2/Synthetic/Test/Low_s')
    ...
    parser.add_argument('--HVI_weight', type=float, default=2.0)
    parser.add_argument('--L1_weight', type=float, default=1.0)
    # parser.add_argument('--L1_weight', type=float, default=1.0)
    parser.add_argument('--mid_hvi_weight', type=float, default=1.0)         # 中间损失的权重
    # parser.add_argument('--Char_weight', type=float, default=1.0)         # CharbonnierLoss
